...
Download the latest version (v1.0.23) for your operating system:

### Windows

**[Download for Windows](https://github.com/codejq/nebulaterm-ai/releases/download/v1.0.23/NebulaTerm-AI_1.0.23_x64-setup.exe)** (64-bit)
...
**[Download for macOS (Apple Silicon)](https://github.com/codejq/nebulaterm-ai/releases/download/v1.0.23/NebulaTerm-AI_1.0.23_aarch64.dmg)** (M1/M2/M3)
...
**Alternative**: [macOS Portable Version](https://github.com/codejq/nebulaterm-ai/releases/download/v1.0.23/NebulaTerm-AI_aarch64.app.tar.gz) (.tar.gz)
...
**[Download .deb](https://github.com/codejq/nebulaterm-ai/releases/download/v1.0.23/nebula-term-ai_1.0.23_amd64.deb)**

```bash
# Download and install
sudo dpkg -i nebula-term-ai_1.0.23_amd64.deb
...
**[Download .rpm](https://github.com/codejq/nebulaterm-ai/releases/download/v1.0.23/nebula-term-ai-1.0.23-1.x86_64.rpm)**

```bash
# Download and install
sudo rpm -i nebula-term-ai-1.0.23-1.x86_64.rpm
# Or use dnf:
sudo dnf install nebula-term-ai-1.0.23-1.x86_64.rpm
```

#### Universal Linux (AppImage)

**[Download AppImage](https://github.com/codejq/nebulaterm-ai/releases/download/v1.0.23/nebula-term-ai_1.0.23_amd64.AppImage)** (Works on any Linux distribution)

```bash
# Download, make executable, and run
chmod +x nebula-term-ai_1.0.23_amd64.AppImage
./nebula-term-ai_1.0.23_amd64.AppImage
```
