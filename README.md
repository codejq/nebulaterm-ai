...
Download the latest version (v1.0.19) for your operating system:

### Windows

**[Download for Windows](https://github.com/codejq/nebulaterm-ai/releases/download/v1.0.19/NebulaTerm-AI_1.0.19_x64-setup.exe)** (64-bit)
...
**[Download for macOS (Apple Silicon)](https://github.com/codejq/nebulaterm-ai/releases/download/v1.0.19/NebulaTerm-AI_1.0.19_aarch64.dmg)** (M1/M2/M3)
...
**Alternative**: [macOS Portable Version](https://github.com/codejq/nebulaterm-ai/releases/download/v1.0.19/NebulaTerm-AI_aarch64.app.tar.gz) (.tar.gz)
...
**[Download .deb](https://github.com/codejq/nebulaterm-ai/releases/download/v1.0.19/nebula-term-ai_1.0.19_amd64.deb)**

```bash
# Download and install
sudo dpkg -i nebula-term-ai_1.0.19_amd64.deb
...
**[Download .rpm](https://github.com/codejq/nebulaterm-ai/releases/download/v1.0.19/nebula-term-ai-1.0.16-1.x86_64.rpm)**
...
**[Download AppImage](https://github.com/codejq/nebulaterm-ai/releases/download/v1.0.19/nebula-term-ai_1.0.19_amd64.AppImage)** (Works on any Linux distribution)

```bash
# Download, make executable, and run
chmod +x nebula-term-ai_1.0.19_amd64.AppImage
./nebula-term-ai_1.0.19_amd64.AppImage
```
